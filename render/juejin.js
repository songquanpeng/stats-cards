function renderJuejinCard(data) {
  ...
  <text id="Juejin" data-name="juejin" transform="translate(94 44)" fill="#212121" font-size="18" font-family="SegoeUI-Bold, Segoe UI" font-weight="700"><tspan x="0" y="0">${user_name}&apos;s Juejin Stats</tspan></text>
  ...
  <text id="Article Views" data-name="Bilibili Level" transform="translate(203 119)" fill="#9e9e9e" font-size="13.5" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Article Views</tspan></text>
